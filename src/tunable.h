...
Tunable(CPUCT, 13285);
Tunable(ROOT_CPUCT, 24257);

Tunable(POLICY_TEMPERATURE, 7318);
Tunable(ROOT_POLICY_TEMPERATURE, 27650);

Tunable(EG_POLICY_TEMPERATURE, 6440);
Tunable(EG_ROOT_POLICY_TEMPERATURE, 24998);

Tunable(EVAL_DIVISOR, 398);
Tunable(CPUCT_VISIT_SCALE, 8758);

Tunable(FPU_SHARPNESS_MARGIN, 484);

Tunable(POLICY_MATERIAL_PHASE_DIVISOR, 4492);

Tunable(BUTTERFLY_BONUS_DIVISOR, 8861);
Tunable(BUTTERFLY_POLICY_DIVISOR, 14233);

Tunable(GINI_BASE, 4710);
Tunable(GINI_SCALAR, 17820);
Tunable(GINI_MIN, 9203);
Tunable(GINI_MAX, 15424);

Tunable(PAWN_VALUE, 101);
Tunable(KNIGHT_VALUE, 311);
Tunable(BISHOP_VALUE, 341);
Tunable(ROOK_VALUE, 514);
Tunable(QUEEN_VALUE, 931);