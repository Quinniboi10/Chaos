...
struct Searcher {
    ...
    void fillRootPolicy(const Board& board) {
        ...
        const SearchParameters                     params(posHistory, ROOT_CPUCT, CPUCT, 1.0, false, false);
    ...
    void bench(const usize depth) {
        ...
        const SearchParameters               params(posHistory, ROOT_CPUCT, CPUCT, TEMPERATURE, false, false);
